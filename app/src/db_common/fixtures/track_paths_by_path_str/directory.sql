...
-- This sets up tracks in the "test/hoge/" directory
...
INSERT INTO tracks (id, duration, path, folder_id, title) VALUES 
    (1, 180, 'test/hoge/track1.mp3', 2, 'Track 1'),
    (2, 240, 'test/hoge/track2.flac', 2, 'Track 2'),
    (3, 200, 'test/hoge/track3.m4a', 2, 'Track 3');

-- test/hoge/ の検索にヒットしない楽曲を作成
INSERT INTO tracks (id, duration, path, folder_id, title) VALUES 
    (4, 180, 'test/fuga.mp3', 1, 'Track DUMMY');
